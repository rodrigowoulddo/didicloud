...
class Storage {
    ...
    static func id(_ name: String) -> CKRecord.ID {
        return CKRecord.ID(recordName: name)
    }

    static func getAll<T: Storable>(privateData: Bool = true, _ completion: @escaping (Result<[T], Error>) -> Void) {
        
        let query = CKQuery(recordType: Todo.reference, predicate: NSPredicate(value: true))
    ...
    static func get<T: Storable>(privateData: Bool = true, recordID: CKRecord.ID, _ completion: @escaping (Result<[T], Error>) -> Void) {
    ...
    static func create<T: Storable>(privateData: Bool = true, _ storable: T, _  completion: @escaping (Result<T, Error>) -> Void) {
    ...
    static func update<T: Storable>(privateData: Bool = true, _ storable: T, _  completion: @escaping (Result<T, Error>) -> Void) {
    ...
    static func remove(privateData: Bool = true, _ recordID: String, completion: @escaping (Result<CKRecord.ID, Error>) -> Void) {
